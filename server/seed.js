...
async function reset(conn) {
  ...
  for (const table of ['Request_exercise_allocation', 'Request_step', 'Leave_request', 'Exercise', 'Attendance', 'Employee', 'Org_unit']) {
...
async function seedEmployees(conn, units) {
  ...
  const roster = [
    ...
    { key: 'hr',       first: 'Lina',    last: 'Zerrouki',   email: 'lina.zerrouki@corp.dz',      role: 'hr',       unit: 'Direction Générale',  drh: false, date: '2019-01-08' },
    { key: 'admin',    first: 'Yasmine', last: 'Kaci',       email: 'yasmine.kaci@corp.dz',       role: 'admin',    unit: 'Direction Générale',  drh: false, date: '2015-01-05' },
